...
app.post('/avatar', async(req, res) => {
  try {
    ...
    VALUES($1, $2, $3, $4, $5, $6)
    RETURNING *
    `, [req.body.name, req.body.element_id, req.body.element_name, req.body.img, req.body.title, 1]);
...
app.put('/avatar/:id', async(req, res) => {
  try {
    const data = await client.query(`
    UPDATE avatar 
    SET name = $1, element_id = $2, element_name= $3, img = $4, title = $5 
    WHERE id=$6 
    RETURNING *
    `, [req.body.name, req.body.element_id, req.body.element_name, req.body.img, req.body.title, req.params.id]);
